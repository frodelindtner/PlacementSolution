...
namespace PlacementTableApp.Infrastructure
{
    public static class DatabaseInitializer
    {
        public static async Task InitializeDatabaseAsync(this IServiceProvider services, CancellationToken cancellationToken = default)
        {
            ...
            var context = scope.ServiceProvider.GetRequiredService<StandingDbContext>();
            var logger = scope.ServiceProvider.GetRequiredService<ILogger<StandingDbContext>>();
        ...
        private static async Task SeedAsync(StandingDbContext context, ILogger logger, CancellationToken cancellationToken)
        {
